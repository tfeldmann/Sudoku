...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=.5\textwidth]{Abbildungen/crossing}
        \includegraphics[width=.5\textwidth]{Abbildungen/grid}
    \end{center}
\end{figure}
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=.5\textwidth]{Abbildungen/sorted_grid}
        \includegraphics[width=.5\textwidth]{Abbildungen/unsorted_grid}
    \end{center}
\end{figure}
...
Die erkannten Ziffern werden anschließend in das Bild hineingeschrieben.
